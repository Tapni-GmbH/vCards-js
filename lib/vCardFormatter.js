    ...
    getFormattedString: function (vCard) {
      ...
      if (vCard.workEmail) {
        ...
        vCard.workEmail.forEach(function (address) {
          if (majorVersion >= 4) {
            ...
            formattedVCardString +=
              "EMAIL" + encodingPrefix + ";type=email:" + e(address) + nl();
          } else {
            formattedVCardString +=
      ...
      */
      ...
      if (vCard.url) {
        ...
        vCard.url.forEach(function (url, i) {
          formattedVCardString +=  "URL;type=website" + encodingPrefix + ":" + e(url) + nl();
        });
      }
      ...
      */
      ...
      if (vCard.workUrl) {
        ...
        vCard.workUrl.forEach(function (url) {
